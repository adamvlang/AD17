...
def init_imu():
    ...
    print("IMU Name: " + imu_instance.IMUName())
    ...
    imu_instance.setCompassEnable(True)

    poll_interval = imu_instance.IMUGetPollInterval()
    print("Recommended Poll Interval: %dmS\n" % poll_interval)   
    
    acc_x, acc_y, acc_z = imu_instance.getAccel()
    gyro_x, gyro_y, gyro_z = imu_instance.getGyro()
    mag_x, mag_y, mag_z = imu_instance.getCompass()

    rospy.loginfo('Initiated IMU')
