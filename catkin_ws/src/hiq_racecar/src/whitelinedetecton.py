...
topicRead = "raw_camera" 
topicPublish = "white_line_location"
...
def draw_lanes_image(image):
    reset_params_for_averaging()
    draw_lanes(image, True, "video_feed")
...
def read_consumer():
	publisher = rospy.Consumer(topicRead, Image)
        print cv2.__version__
	bridge = CvBridge()
	rospy.init_node('white_line_detecor', anonymous=True)
        rate = rospy.Rate(10)
